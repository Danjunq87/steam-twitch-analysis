...
jogos_faltando = [
    ...
    {'name': 'RetroMMO', 'tipo': 'MMO', 'indie': True, 'price': 0.0, 'release_date': '2021-01-01'},
    {'name': 'Crosswind', 'tipo': 'Single Player', 'indie': True, 'price': 19.99, 'release_date': '2025-01-01'},
    {'name': 'Hell Clock', 'tipo': 'Single Player', 'indie': True, 'price': 14.99, 'release_date': '2025-01-01'},
    {'name': 'Static Dread: The Lighthouse', 'tipo': 'Single Player', 'indie': True, 'price': 9.99, 'release_date': '2025-01-01'},
    {'name': 'Mistfall Hunter', 'tipo': 'Single Player', 'indie': True, 'price': 19.99, 'release_date': '2025-01-01'},
    {'name': 'Amanda the Adventurer 3', 'tipo': 'Single Player', 'indie': True, 'price': 9.99, 'release_date': '2025-01-01'},
    {'name': 'Night Club Simulator', 'tipo': 'Single Player', 'indie': True, 'price': 14.99, 'release_date': '2025-01-01'},
    {'name': 'SpongeBob SquarePants: Battle for Bikini Bottom', 'tipo': 'Single Player', 'indie': False, 'price': 29.99, 'release_date': '2020-06-23'},
    {'name': 'Olympic Games Tokyo 2020', 'tipo': 'Multiplayer', 'indie': False, 'price': 39.99, 'release_date': '2021-07-22'},
    {'name': 'BLEACH Rebirth of Souls', 'tipo': 'Multiplayer', 'indie': False, 'price': 59.99, 'release_date': '2025-03-21'},
    {'name': 'Solo Leveling:ARISE', 'tipo': 'Multiplayer', 'indie': False, 'price': 0.0, 'release_date': '2024-05-08'},
    {'name': 'Divinity: Original Sin II', 'tipo': 'Multiplayer', 'indie': False, 'price': 44.99, 'release_date': '2017-09-14'},
    {'name': 'Dragon Age: The Veilguard', 'tipo': 'Single Player', 'indie': False, 'price': 59.99, 'release_date': '2024-10-31'},
    {'name': 'Microsoft Flight Simulator', 'tipo': 'Single Player', 'indie': False, 'price': 0.0, 'release_date': '2024-11-19'},
    {'name': 'Life Is Strange', 'tipo': 'Single Player', 'indie': False, 'price': 0.0, 'release_date': '2015-01-30'},
    {'name': 'Fallout 3', 'tipo': 'Single Player', 'indie': False, 'price': 9.99, 'release_date': '2008-10-28'},
    {'name': 'The Precinct', 'tipo': 'Single Player', 'indie': False, 'price': 29.99, 'release_date': '2025-05-13'},
    {'name': 'White Knuckle', 'tipo': 'Multiplayer', 'indie': True, 'price': 19.99, 'release_date': '2025-04-03'},
    {'name': 'The Last Caretaker', 'tipo': 'Single Player', 'indie': True, 'price': 14.99, 'release_date': '2025-01-01'},
    {'name': 'Magical Girl Witch Trials', 'tipo': 'Single Player', 'indie': True, 'price': 9.99, 'release_date': '2025-01-01'},
    {'name': 'Paddle Paddle Paddle', 'tipo': 'Multiplayer', 'indie': True, 'price': 9.99, 'release_date': '2025-01-01'},
    {'name': 'Of Ash and Steel', 'tipo': 'Multiplayer', 'indie': True, 'price': 0.0, 'release_date': '2025-01-01'},
    {'name': 'Quarantine Zone: The Last Check', 'tipo': 'Single Player', 'indie': True, 'price': 9.99, 'release_date': '2025-01-01'},
    {'name': 'Dread Flats', 'tipo': 'Single Player', 'indie': True, 'price': 9.99, 'release_date': '2025-01-01'},
    {'name': 'Deadly Days: Roadtrip', 'tipo': 'Single Player', 'indie': True, 'price': 14.99, 'release_date': '2025-01-01'},
    {'name': 'Blood on the Clocktower', 'tipo': 'Multiplayer', 'indie': True, 'price': 9.99, 'release_date': '2025-01-01'},
    {'name': 'Space Station 13', 'tipo': 'Multiplayer', 'indie': True, 'price': 0.0, 'release_date': '2003-01-01'},
    {'name': 'IdleOn', 'tipo': 'Multiplayer', 'indie': True, 'price': 0.0, 'release_date': '2021-01-01'},
    {'name': 'Exoborne', 'tipo': 'Multiplayer', 'indie': False, 'price': 0.0, 'release_date': '2025-03-14'},
    {'name': 'Blade & Soul NEO', 'tipo': 'MMO', 'indie': False, 'price': 0.0, 'release_date': '2024-12-18'},
    {'name': 'UFL', 'tipo': 'Multiplayer', 'indie': False, 'price': 0.0, 'release_date': '2024-09-05'},
    {'name': 'Gears 5', 'tipo': 'Multiplayer', 'indie': False, 'price': 0.0, 'release_date': '2019-09-10'},
    {'name': 'The Elder Scrolls IV: Oblivion', 'tipo': 'Single Player', 'indie': False, 'price': 5.99, 'release_date': '2006-03-20'},
    ...
    {'name': 'Resident Evil 3: Nemesis', 'tipo': 'Single Player', 'indie': False, 'price': 0.0, 'release_date': '1999-09-22'},
    {'name': 'Batman: Arkham Asylum', 'tipo': 'Single Player', 'indie': False, 'price': 19.99, 'release_date': '2009-08-25'},
    ...
    {'name': 'The Lord of the Rings Online', 'tipo': 'MMO', 'indie': False, 'price': 0.0, 'release_date': '2007-04-24'},
    {'name': 'Star Wars Jedi: Survivor', 'tipo': 'Single Player', 'indie': False, 'price': 49.99, 'release_date': '2023-04-28'},
    {'name': 'Battlefield V', 'tipo': 'Multiplayer', 'indie': False, 'price': 0.0, 'release_date': '2018-11-20'},
    {'name': 'FINAL FANTASY VII REMAKE', 'tipo': 'Single Player', 'indie': False, 'price': 69.99, 'release_date': '2021-12-16'},
    {'name': 'MiniRoyale', 'tipo': 'Multiplayer', 'indie': False, 'price': 0.0, 'release_date': '2020-01-01'},
